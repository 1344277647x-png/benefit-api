...
export const STATIC_I18N_KEYS = [
  ...
  'Client setup guides and reusable API skills.',
  'Codex CLI',
  'Claude Code',
  'Gemini',
  'OpenAI SDK',
  ...
  'OpenAI-compatible text embedding request.',
  'Rerank documents with a model enabled for this token.',
  'Chat Completions',
  'Responses',
  'Claude Messages',
  'Image generation',
  ...
  // Benefit API onboarding and client configuration templates
  'cURL',
  'OpenAI SDK',
  'Codex CLI',
  'Cherry Studio',
  'Test the gateway from any terminal',
  'Use the official OpenAI Python client',
  'A minimal custom provider configuration',
  ...
  'Open key management',
  'Choose a protocol',
  'Match the protocol to your client.',
  'Copy and run',
  'Replace the placeholders, then send your first request.',
  'Request protocol',
  'Chat Completions',
  'Responses',
  'Use Responses for Codex and modern reasoning clients.',
  'Use Chat Completions for OpenAI-compatible SDKs and clients.',
  'Model identifier',
  'Use the exact model ID shown in Model Square.',
  'Request endpoint',
  'Copy endpoint',
  'Install',
  'Config path',
